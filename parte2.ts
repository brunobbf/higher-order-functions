...
const getPlatformCharData = (records : RecordItem[]) => {
...
const getGenderChartData = (records : RecordItem[]) => {
...
console.log(getPlatformCharData(recordItemList));

console.log('GRÁFICO DE ROSCA (GÊNEROS) --------------------------');
console.log(getGenderChartData(recordItemList));